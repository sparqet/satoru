...
// *************************************************************************
//                  Interface of the `Referral_utils` contract.
// *************************************************************************
#[starknet::interface]
trait IReferral_utils<TContractState> { 
    fn set_trader_referral_code(
        ...
        fn get_referral_info(
            ref self: TContractState, referral_storage: IReferralStorageDispatcher, trader: ContractAddress
...
mod Referral_utils {
    ...
    // *************************************************************************
    #[abi(embed_v0)]
    impl Referral_utils of super::IReferral_utils<ContractState> {
        ...
        fn set_trader_referral_code(
            ref self: ContractState, referral_storage: IReferralStorageDispatcher, account: ContractAddress, referral_code: felt252
        ) {
            if (referral_code == 0) {
                return;
            }
        ...
        /// The referral code, the affiliate's address, the total rebate, and the discount share.
        fn get_referral_info(
            ref self: ContractState, referral_storage: IReferralStorageDispatcher, trader: ContractAddress
        ) -> (felt252, ContractAddress, u128, u128) {
